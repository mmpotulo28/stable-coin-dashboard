...
export default function DocsPage() {
	return (
		<div className="max-w-full w-full mx-auto py-10 px-4 overflow-auto">
			<Card className="shadow-2xl border border-default-200 bg-gradient-to-br from-default-50 to-default-100">
				<CardHeader className="flex flex-col items-center gap-2 pb-2">
					...
					<p className="text-default-600 text-center max-w-xl">
						Welcome! This dashboard lets you manage users, business accounts, transfers,
						charges, API tokens, and transactions with a modern, intuitive interface.
					</p>
				</CardHeader>
				<CardBody className="space-y-10">
					<section>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="flex gap-2 items-start">
								...
								<span>
									Create payment requests, view, update, and delete charges for
									users.
								</span>
							</div>
							<div className="flex gap-2 items-start">
								...
								<span>
									Create, update, revoke, and search API tokens for integrations.
								</span>
							</div>
							<div className="flex gap-2 items-start">
								<Chip color="secondary" variant="flat">
								...
								<span>
									View all transactions, user balances, and search for specific
									transactions.
								</span>
							</div>
						</div>
					...
					<section>
						...
						<ul className="space-y-3 text-default-700">
							<li>
								...
								Users, Business, Transfers, Charges, API Tokens, Transactions, and
								Settings.
							</li>
							<li>
								<b>User Management:</b> View all users, create new users, update or
								delete existing users, and search for a user by ID.
							</li>
							<li>
								<b>Business Management:</b> View token balances, mint stablecoins,
								enable gas for business or users, and monitor pending transactions.
							</li>
							<li>
								<b>Transfers:</b> Find recipients, make single transfers, or execute
								batch payments.
							</li>
							<li>
								<b>Charges:</b> Create payment requests, view all charges, update
								charge details, or delete charges.
							</li>
							<li>
							...
							<li>
								<b>Transactions:</b> View all transactions, search by user, or look
								up specific transaction details.
							</li>
						</ul>
					</section>
					<Divider />
					<section>
						...
						<ul className="space-y-2 text-default-700">
							<li>
								<Icon icon="lucide:search" className="inline text-primary mr-1" />
							...
							<li>
								...
								Copy and store API tokens securely when created; they are only shown
								once.
							</li>
							<li>
							...
							<li>
								...
								/>
								Refer to inline help and tooltips for guidance on specific actions.
							</li>
						</ul>
					</section>
					<Divider />
					<section>
						...
						<p className="mb-2 text-default-700">
							...
							comments. You can customize navigation, add new features, or change the
							site configuration as needed.
						</p>
						<Snippet
							hideSymbol
							variant="bordered"
							...
							https://github.com/your-org/stable-coin-dashboard
						</Snippet>
					</section>
					<Divider />
					<section>
