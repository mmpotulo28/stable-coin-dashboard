...
export default function SignUpPage() {
	...
	return (
		<div className="min-h-screen flex flex-col bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526] relative overflow-hidden">
			...
			<LandingHeader />
			<div className="min-h-screen flex items-center justify-center py-16 relative z-10">
				<Card className="w-full max-w-4xl flex flex-col md:flex-row shadow-2xl border border-primary/30 bg-white/10 backdrop-blur-2xl overflow-hidden rounded-3xl glass-card-glow">
					...
					<div className="hidden md:flex flex-col justify-between items-center bg-gradient-to-br from-primary-100 to-primary-50 p-10 w-1/2 min-h-[500px] relative">
						...
						<div className="flex flex-col items-center gap-6">
							...
							<p className=" text-center max-w-xs font-medium ">
								Sign up to start managing users, business accounts, transfers, and
								more. Your data is protected with industry-leading security.
							</p>
						</div>
					...
					{/* Right: Sign Up Form */}
					<div className="flex-1 flex flex-col items-center justify-center p-0 relative bg-background w-fit">
						<SignUp
							oauthFlow="popup"
							appearance={{
								elements: {
			...
			<style jsx global>{`
				...
				.clerk-signup-wrapper .cl-internal-1fsg6zy {
					background: transparent !important;
				}
				.clerk-signup-wrapper .cl-internal-1fsg6zy input {
					background: #f8fafc22 !important;
					color: #232526 !important;
				}
				.clerk-signup-wrapper .cl-internal-1fsg6zy label {
					color: #2c5364 !important;
				}
				.clerk-signup-wrapper .cl-internal-1fsg6zy .cl-internal-1fsg6zy {
